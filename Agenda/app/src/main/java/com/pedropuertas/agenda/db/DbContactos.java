package com.pedropuertas.agenda.db;
...
public class DbContactos extends DbHelper {
    ...
    public boolean editarContacto(int id, String nombre, String telefono, String correo_electronico, String fecha_nacimiento) {
        ...
        try {
            db.execSQL("UPDATE " + TABLE_CONTACTOS + " SET nombre = '" + nombre + "', telefono = '" + telefono + "', correo_electronico = '" + correo_electronico + "', fecha_nacimiento = '" + fecha_nacimiento + "' WHERE id='" + id + "' ");
            correcto = true;
        } catch (Exception ex) {
            ex.toString();
            correcto = false;
